...
# ....print numPedals....
    ...
    GPIO.add_event_detect(BtnPin, GPIO.RISING, callback=BtnSelect,
                          bouncetime=200)
...
# init the selected values to 0
    ...
    image = Image.open('./images/Cole.jpg').resize((128, 64),
    ...
    if Switch_A and Switch_B:  # Both one active? Yes -> end of sequence
        ...
        if A_or_B == Enc_B:  # Turning direction depends on
            Rotary_counter += 1  # which input gave last interrupt
                                                     ...
                                                     # so depending on direction either
            ...
            if curr_active == False:  # only look for rotating if the pedal is not active.....................
                ...
                if NewCounter != 0:  # Counter has CHANGED
                    ...
                    if Image_cnt < 0 or Image_cnt > numPedals:  # sometimes things get confused if you spin the knob fast.  reset to 0 image
                        Image_cnt = 0
                    image = \
                        Image.open(switch_image(Image_cnt)).resize((128,
                            64), Image.ANTIALIAS).convert('1')
            ...
            if launchPedal == True:
                if curr_active == True:
                    ...
                    if effects[Image_cnt] == 'Reverb':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/reverb'
                                )
                        launchPedal = False
                    if effects[Image_cnt] == 'Booster':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/booster'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Distortion':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/distortion'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Echo':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/echo'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Looper':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/looper'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Fuzz':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/fuzz'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Tremolo':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/tremolo'
                                )
                        launchPedal = False
                    ...
                    if effects[Image_cnt] == 'Bitcrusher':
                        ...
                        activePedal = \
                            subprocess.Popen('./Pedal-Pi-All-Effects/bitcrusher'
                                )
                        launchPedal = False
                else:
